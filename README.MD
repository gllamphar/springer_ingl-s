...
If you want just one or two specific books, get the excel file from the following link and download just those: https://resource-cms.springernature.com/springer-cms/rest/v1/content/17858272/data/v4

It took about 4 hours to complete the 409 english books (14 GB, both PDF and epub) on my machine.

Edit in Spanish:
Esta versión del código realiza la descarga directamente en inglés. Ya no es necesario modificar nada. 
